...
export default function LoginModal({ open, onClose }: Props) {
  ...
  return (
    <div
      className={`login-overlay ${open ? 'open' : ''}`}
    ...
    >
      <div className="login-box">
        ...
        {authError ? (
          <>
            <div className="login-error" style={{ marginBottom: '1.2rem' }}>{authError}</div>
            <button className="login-submit" onClick={handleClose}>CLOSE</button>
          </>
        ) : (
          <>
